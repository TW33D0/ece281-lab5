...
begin
    ...
    begin
        ...
        w_bin <= "11110000";
        wait for 10 ns;
        assert w_sign = "1010" and w_hund = "0000" and w_tens = "0001" and w_ones = "0110" report "Bad convert -16" severity error;
        ...
        w_bin <= "10001000";
        wait for 10 ns;
        assert w_sign = "1010" and w_hund = "0001" and w_tens = "0010" and w_ones = "0000" report "Bad convert -120" severity error;
